...
namespace UwUtils
{
    ...
    public class onRespawnEventRelay : UdonSharpBehaviour
    {
        ...
        {
            if (enableLogging) Debug.Log("[UwUtils/onRespawnEventRelay.cs]: Player" + player .displayName + " respawned, triggering "+TargetBehaviours.Length+" target Behaviours from :"+ gameObject.name + "", gameObject);
